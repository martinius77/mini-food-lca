...
# End-to-end compare render (the "local cheese vs imported strawberries" surprise).
def test_compare_renders_both_cards(client):
    r = client.post(
        "/compare",
    ...
    assert "CO" in html  # carbon unit present
